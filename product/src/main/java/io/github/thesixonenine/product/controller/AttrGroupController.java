...
public class AttrGroupController {
    ...
    @ApiOperation(value = "获取分类下所有的分组/关联属性")
    @GetMapping(value = "/{catelogId}/withattr")
    public R listAttrGroupWithAttrs(@PathVariable(value = "catelogId") Long catelogId) {
        // AttrGroupVO
        List<AttrGroupVO> data = attrGroupService.listAttrGroupWithAttrsByCatelogId(catelogId);
